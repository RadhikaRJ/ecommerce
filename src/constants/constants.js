...
export const SUCCESSFULLY_FETCHED_USER_WISHLIST_DATA =
  "SUCCESSFULLY_FETCHED_USER_WISHLIST_DATA";
export const FAILED_TO_FETCH_USER_WISHLIST_DATA =
  "FAILED_TO_FETCH_USER_WISHLIST_DATA";
export const SUCCESSFULLY_FETCHED_USER_CART_ITEMS =
  "SUCCESSFULLY_FETCHED_USER_CART_ITEMS";
export const FAILED_TO_FETCH_USER_CART_ITEMS =
