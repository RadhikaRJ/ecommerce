      ...
      <div className="product-detail-card apply-shadow">
        ...
        <div className="product-detail-description-container">
          ...
          <div className="product-description-section">
            <p>
              <strong>Price:</strong> Rs.{detailsOfProduct.price} /-{" "}
            </p>
            <p>
              <strong>Brand:</strong> {detailsOfProduct.brand}
            </p>
            <p>
              <strong>Availability:</strong>{" "}
              {detailsOfProduct.inStock
                ? "Available"
                : "Currently out of stock"}
            </p>
            <p>
              <strong>Delivery:</strong>{" "}
              {detailsOfProduct.fastDelivery
                ? "Fast delivery available"
                : "3 days minimum"}
            </p>
            <p>
              <strong>Ideal for :</strong> {detailsOfProduct.idealFor}
            </p>
            <p>
              <strong>Suggested for:</strong> {detailsOfProduct.level} level
              gardeners
            </p>
            <p>
              <strong>Description:</strong> {detailsOfProduct.description}
            </p>
          </div>
        </div>
      </div>
